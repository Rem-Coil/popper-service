...
fun DI.Builder.v2Components() {
    ...
    bind<com.remcoil.service.v2.KitService>() with singleton { com.remcoil.service.v2.KitService(instance(), instance(), instance(), instance(), instance(), instance())}
    bind<com.remcoil.service.v2.SpecificationService>() with singleton { com.remcoil.service.v2.SpecificationService(instance(), instance(), instance())}
