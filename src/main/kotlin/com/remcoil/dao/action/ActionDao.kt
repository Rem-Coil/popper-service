...
class ActionDao(private val database: Database) {
    ...
    suspend fun updateAction(action: Action) = safetySuspendTransaction(database) {
    ...
    suspend fun createAction(action: Action): Action = safetySuspendTransaction(database) {
