...
import com.remcoil.data.database.v2.view.ExtendedSpecifications
...
class SpecificationDao(private val database: Database) {
    ...
    private fun extractExtendedSpecification(row: ResultRow): SpecificationResponse = SpecificationResponse(
